...
export function useAlertDialog() {
  ...
  const [alertProps, setProps] = React.useState<
    Omit<React.ComponentProps<typeof AlertDialogComponent>, 'open' | 'setOpen'>
  >({});

  const alertDialog = (props: typeof alertProps) => {
    setProps({...props});
    setOpen(true);
  };

  return {alertDialog, alertProps: {...alertProps, open, setOpen}};
}
